    ...
    return (
        <Card className="border border-border shadow-2xl bg-gradient-to-br from-card via-card/95 to-card overflow-hidden relative">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute top-20 right-16 w-2 h-2 bg-accent rounded-full animate-pulse opacity-50" style={{ animationDelay: '0.5s' }} />
                <div className="absolute top-12 left-1/3 w-1.5 h-1.5 bg-accent rounded-full animate-pulse opacity-60" style={{ animationDelay: '1s' }} />
                <div className="absolute bottom-20 left-12 w-2.5 h-2.5 bg-amber-500 rounded-full animate-pulse opacity-40" style={{ animationDelay: '0.3s' }} />
                <div className="absolute bottom-32 right-8 w-2 h-2 bg-accent rounded-full animate-pulse opacity-50" style={{ animationDelay: '0.8s' }} />
            ...
            <CardHeader className="relative z-10 text-center pb-4">
                <div className="flex items-center justify-center gap-3">
                    ...
                    <Wand2 className="h-5 w-5 text-primary animate-bounce" style={{ animationDelay: '0.1s' }} />
                </div>
            ...
            <CardContent className="relative z-10 space-y-6 pb-8 px-4">
                ...
                <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6 pt-4">
                    <div className="flex flex-col items-center gap-2">
                        <span className="text-xs font-bold text-accent uppercase tracking-wider">Situation</span>
